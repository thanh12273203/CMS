...
void DetFrameProducer::fillTRKlayersAtECALstitchedTOB ( const edm::Event& iEvent, const edm::EventSetup& iSetup, unsigned int proj ) {
...
//    std::cout << "Strip Id = " << id << " - subId ( 3->TIB | 4->TID | 5->TOB | 6->TEC ) = " << subid << " - Layer = " << layer <<  std::endl;
    ...
    ( hEvt_EE_TOB, vTOB_ECAL_, hTOB_ECAL, nTOB, proj);
